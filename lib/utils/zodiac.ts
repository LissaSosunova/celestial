...
export function getZodiacBySignName(signName: string): ZodiacSignData | null {
  ...
  const zodiacData = {
    'Aries': { signKey: 'zodiac.signs.aries', emoji: '♈', elementKey: 'zodiac.elements.fire', iconUnicode: '&#9800;', datesKey: 'zodiac.dates.aries' },
    'Taurus': { signKey: 'zodiac.signs.taurus', emoji: '♉', elementKey: 'zodiac.elements.earth', iconUnicode: '&#9801;', datesKey: 'zodiac.dates.taurus' },
    'Gemini': { signKey: 'zodiac.signs.gemini', emoji: '♊', elementKey: 'zodiac.elements.air', iconUnicode: '&#9802;', datesKey: 'zodiac.dates.gemini' },
    'Cancer': { signKey: 'zodiac.signs.cancer', emoji: '♋', elementKey: 'zodiac.elements.water', iconUnicode: '&#9803;', datesKey: 'zodiac.dates.cancer' },
    'Leo': { signKey: 'zodiac.signs.leo', emoji: '♌', elementKey: 'zodiac.elements.fire', iconUnicode: '&#9804;', datesKey: 'zodiac.dates.leo' },
    'Virgo': { signKey: 'zodiac.signs.virgo', emoji: '♍', elementKey: 'zodiac.elements.earth', iconUnicode: '&#9805;', datesKey: 'zodiac.dates.virgo' },
    'Libra': { signKey: 'zodiac.signs.libra', emoji: '♎', elementKey: 'zodiac.elements.air', iconUnicode: '&#9806;', datesKey: 'zodiac.dates.libra' },
    'Scorpio': { signKey: 'zodiac.signs.scorpio', emoji: '♏', elementKey: 'zodiac.elements.water', iconUnicode: '&#9807;', datesKey: 'zodiac.dates.scorpio' },
    'Sagittarius': { signKey: 'zodiac.signs.sagittarius', emoji: '♐', elementKey: 'zodiac.elements.fire', iconUnicode: '&#9808;', datesKey: 'zodiac.dates.sagittarius' },
    'Capricorn': { signKey: 'zodiac.signs.capricorn', emoji: '♑', elementKey: 'zodiac.elements.earth', iconUnicode: '&#9809;', datesKey: 'zodiac.dates.capricorn' },
    'Aquarius': { signKey: 'zodiac.signs.aquarius', emoji: '♒', elementKey: 'zodiac.elements.air', iconUnicode: '&#9810;', datesKey: 'zodiac.dates.aquarius' },
    'Pisces': { signKey: 'zodiac.signs.pisces', emoji: '♓', elementKey: 'zodiac.elements.water', iconUnicode: '&#9811;', datesKey: 'zodiac.dates.pisces' }
  };
