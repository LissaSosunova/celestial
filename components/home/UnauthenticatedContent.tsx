  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-5">
      <div className="lg:col-span-8 space-y-12">
        <h1 className="text-2xl md: text-4xl lg:text-5xl mb-8 leading-[1.1] tracking-tight text-dark  font-light">
          {t.rich('title', {
            br: () => <br />,
            soul: (chunks) => <span className="font-extrabold text-text-muted pl-12">{chunks}</span>
          })}
        </h1>
