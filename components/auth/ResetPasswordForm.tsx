    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-text/60">
          We sent a verification code to <span className="font-medium text-gold">{email}</span>
        </p>
      ...
      <div>
        ...
        {errors.newPassword && <p className="mt-2 text-xs text-red-500">{errors.newPassword}</p>}
      </div>
